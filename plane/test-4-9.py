...
from plane.setting import Settings
from plane.hero import Hero
...
heroBullet_imge = pygame.image.load('images/bullet.png')  # 英雄机的子弹
...
def shootAction():
    ...
    shootIndex +=1
    if shootIndex % 10 ==0:
        heroBullet=hero.shoot(heroBullet_imge)
